export default {
    accounts: {
      ...
      domesticTool: {
        ...
        pasteAuthJson: 'Paste auth JSON',
        pasteAuthJsonPlaceholder: 'Paste the whole JSON returned by the authorization endpoint, then click "Parse & fill" to auto-populate the fields below',
        parseJson: 'Parse & fill',
        authJsonInvalid: 'Failed to parse auth JSON, please check the format',
        oneClickAuth: 'Authorize & add',
        authorizing: 'Authorizing…',
        authorizeFailed: 'One-click authorization failed',
        oauthSuccess: 'Authorization succeeded, account list refreshed',
        oauthStarting: 'Opened the authorization page, please finish it in the new window…',
