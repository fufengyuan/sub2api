export default {
    ...
    groups: {
      ...
      compositeRoutes: {
        ...
        fallbackTargets: 'Fallback target platforms',
        fallbackTargetsHint: 'When the primary platform has no healthy account or insufficient credits, requests automatically fail over to the next platform in list order.',
        addFallbackTarget: 'Add fallback target',
        notes: 'Notes',
        enabled: 'Enabled',
        preview: 'Preview',
        matched: 'Matched',
