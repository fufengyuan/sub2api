export default {
    accounts: {
      ...
      domesticTool: {
        ...
        pasteAuthJson: '粘贴 auth JSON',
        pasteAuthJsonPlaceholder: '可将授权接口返回的整段 JSON 粘贴到这里，点击「解析填入」自动回填下方字段',
        parseJson: '解析填入',
        authJsonInvalid: 'auth JSON 解析失败，请检查格式',
        oneClickAuth: '一键授权添加',
        authorizing: '授权中…',
        authorizeFailed: '一键授权失败',
        oauthSuccess: '授权成功，已刷新账号列表',
        oauthStarting: '已打开授权页面，请在新窗口完成授权…',
        oauthPending: '等待授权完成…',
